...
## v3 보완
이1.1계약만으로 원문v2.2의 모든 provenance/출력필드를 충족하지 않습니다. V22_CONTRACT_GAPS.md와 collection manifest를 함께 구현합니다. 원문과 강화된 exact-set/blocked 계약의 차이는 SOURCE_RECONCILIATION 및 OPEN_DECISIONS에 기록되어 있습니다.
